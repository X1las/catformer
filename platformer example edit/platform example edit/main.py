    ...
    def update(self):
        ...
        if self.player.rect.right >= WIDTH * 2/3:
            ...
            for plat in self.platforms:
                plat.rect.centerx   -= max(abs(self.player.vel.x),2)
        ...
        # if player hits powerupqweqewqweqwe
        ...
        #while len(self.platforms) < 8:
         #   width = random.randrange(50, 100)
          #  Platform(self, random.randrange(0, HEIGHT - width),
           #          random.randrange(HEIGHT - width), 200, 40)
